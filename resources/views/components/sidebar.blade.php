<div class="flex flex-col h-full bg-white text-black w-64" >
    <div class="flex items-center justify-center h-16 border-b border-gray-200">
        <span class="text-xl font-bold text-black">
            <img src="{{ asset('ECO.png') }}" alt="EcoBin Logo" style="width: 150px; height: 130px;">
        </span>
    </div>
    ...
    <div class="flex-1 overflow-y-auto py-4">
        <nav class="px-2 space-y-2">
            ...
            <!-- Bins Management -->
            <a href="{{ route('bins.index') }}" class="group flex items-center px-2 py-4 text-sm font-medium rounded-md {{ request()->routeIs('bins.*') ? 'bg-blue-100 text-blue-600' : 'text-black hover:bg-gray-100' }}">
            ...
            <!-- User Management -->
            <a href="{{ route('users.index') }}" class="group flex items-center px-2 py-4 text-sm font-medium rounded-md {{ request()->routeIs('users.*') ? 'bg-blue-100 text-blue-600' : 'text-black hover:bg-gray-100' }}">
            ...
            <!-- Location -->
            <a href="{{ route('locations.index') }}" class="group flex items-center px-2 py-4 text-sm font-medium rounded-md {{ request()->routeIs('locations.*') ? 'bg-blue-100 text-blue-600' : 'text-black hover:bg-gray-100' }}">
            ...
            <!-- Messages -->
            <a href="{{ route('messages.index') }}" class="group flex items-center px-2 py-4 text-sm font-medium rounded-md {{ request()->routeIs('messages.index') ? 'bg-blue-100 text-blue-600' : 'text-black hover:bg-gray-100' }}">
            ...
            <a href="{{ route('messages.list') }}" class="group flex items-center px-2 py-4 text-sm font-medium rounded-md {{ request()->routeIs('messages.list') ? 'bg-blue-100 text-blue-600' : 'text-black hover:bg-gray-100' }}">
    ...
    <div class="border-t border-gray-200 p-6 bg-white">
        ...
        <div class="mt-8 space-y-1">
            <a href="{{ route('help') }}" class="group flex items-center px-4 py-1 text-sm font-medium rounded-md text-black hover:bg-gray-100">
