                                    ...
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <div class="flex space-x-3">
                                                <a href="{{ route('locations.show', $location->id) }}" class="text-blue-600 hover:text-blue-900">
                                                ...
                                                @if(auth()->user()->isAdmin())
                                                <a href="{{ route('locations.edit', $location->id) }}" class="text-indigo-600 hover:text-indigo-900">
                                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="5" class="px-6 py-4 whitespace-nowrap text-center text-gray-500">
                                            No locations found. @if(auth()->user()->isAdmin()) Click "Add New Location" to create one. @endif
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
