...
<div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="max-w-2xl mx-auto">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-semibold text-gray-900">Edit Bin Level</h1>
        ...
        <form action="{{ route('bin-levels.update', $binLevel->id) }}" method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            @csrf
            @method('PUT')
            ...
            <div class="mb-4">
                ...
                <select name="bin_id" id="bin_id" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('bin_id') border-red-500 @enderror" required>
                    ...
                    @foreach($bins as $bin)
                        <option value="{{ $bin->id }}" {{ old('bin_id', $binLevel->bin_id) == $bin->id ? 'selected' : '' }}>
            ...
            <div class="mb-4">
                ...
                <input type="number" name="plastic_level" id="plastic_level" min="0" max="100" value="{{ old('plastic_level', $binLevel->plastic_level) }}" 
            ...
            <div class="mb-4">
                ...
                <input type="number" name="paper_level" id="paper_level" min="0" max="100" value="{{ old('paper_level', $binLevel->paper_level) }}"
            ...
            <div class="mb-6">
                ...
                <input type="number" name="metal_level" id="metal_level" min="0" max="100" value="{{ old('metal_level', $binLevel->metal_level) }}"
